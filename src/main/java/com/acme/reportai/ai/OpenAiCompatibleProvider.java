...
public class OpenAiCompatibleProvider implements AiProvider {
    ...
    public AiClassification classify(FailureCluster cluster) {
        try {
            ...
            String userPrompt =
                    "Analiza este error QA y devuelve JSON con keys category, probableCause, recommendation, summary. "
                            + "Mensaje: " + cluster.getNormalizedMessage()
                            + ". Casos: " + cluster.getCases().size();
            ...
            systemMessage.put("content", "Eres un analista QA. Devuelves solo JSON válido.");
            ...
            String payload = mapper.writeValueAsString(rootRequest);
            ...
            try (InputStream is = conn.getInputStream()) {
                ...
                c.setSummary(node.path("summary").asText("Clasificación vía API compatible"));
                return c;
            }
